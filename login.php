...
<html class="no-js"> <!--<![endif]-->
	...
	<title>Medcare &mdash; Log In</title>
					...
					<form action= "login.php" method="POST" class="appointment-wrap animate-box">
                        ...
                        <div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="pass_1" name='password' class="form-control" placeholder="Password">
							</div>
						</div>
						...
						<div class="form-group">
							<input type="submit" value="Log In" name= "login_user" class="btn btn-primary">
						</div>
						<p>
