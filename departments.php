...
<html class="no-js"> <!--<![endif]-->
	...
	<title>Medcare &mdash;Dept.</title>
  ...
  margin-top: 0px;
	...
	<aside id="qbootstrap-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/stet.jpg);">
			...
			<div class="row">
				<div class="department-wrap animate-box">
					...
					<div class="grid-2 col-md-6">
						<div class="desc">
							<h2><a href="departments-single.php">Plastic Surgery Department</a></h2>
							
							<div class="department-info">
								<div class="block">
									<h2><a href="doctors-single.php">Paul Merriweather</a></h2>
									<span>Head Department</span>
								</div>
								<div class="block">
									<h2><a href="departments-single.php">Department info</a></h2>
									<span>Block B, 3rd floor</span>
								</div>
								<div class="block">
									<h2><a href="doctors.php">Find a Doctor</a></h2>
									<span>See doctors in this department</span>
								</div>
								<div class="block">
									<h2><a href="appointment.php">Request an appointment</a></h2>
				...
				<div class="department-wrap animate-box">
					...
					<div class="grid-2 col-md-6 col-md-pull-6">
						<div class="desc">
							<h2><a href="departments-single.php">Dental Department</a></h2>
				...
				<div class="department-wrap animate-box">
					...
					<div class="grid-2 col-md-6">
						<div class="desc">
							<h2><a href="departments-single.php">Psychological Department</a></h2>
