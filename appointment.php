...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Medcare &mdash; Appointment</title>
  ...
  margin-top: 0px;
	...
	<aside id="qbootstrap-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/appoint.jpg);">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<form action="appointment.php" method= "POST" class="appointment-wrap animate-box">
					  <?php include('errors.php')?>
						...
						<div class="row form-group">
							<div class="col-md-6">
								...
								<select name='dept' class="selectpicker form-control">
						...
						<center><div class="form-group">
							<input type="submit" value="Book Appointment" name="appointment" class="btn btn-primary">
						</div></center>
