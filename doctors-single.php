						...
						<div class="menu-1">
							<ul>
								...
								<li class="has-dropdown">
								    ...
								    <ul class = "dropdown">
								    	<li><a href="location.html">Hospitals</a></li>
		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1>About Dr. <strong> Steven Strange </strong></h1>
			...
			<div class="row">
				<div class="col-md-8 image-content">
					<div class="doctor animate-box">
						<img class="img-responsive" src="images/img_bg_1.jpg" alt="">
						<h2><a href="doctors-single.php">Dr. Steven Strange</a></h2>
						...
						<div class="desc">
							<p>Doctors, also known as Physicians, are licensed health professionals who maintain and restore human health through the practice of medicine. They examine patients, review their medical history, diagnose illnesses or injuries, administer treatment and counsel patients on their health and well being.</p><br>
							<h3>Biography</h3>
							<p>Doctors, also known as Physicians, are licensed health professionals who maintain and restore human health through the practice of medicine. They examine patients, review their medical history, diagnose illnesses or injuries, administer treatment and counsel patients on their health and well being.</h3>
						...
						<div class="contact-info">
							<h2>Contacts</h2>
							<p><i class="icon-location4"></i>Medical College Road, Laxmipur, Rajpara, Rajshahi-6100,Bangladesh</p>
							<p><i class="icon-phone-outline"></i> +880123-456-789</p>
							<p><i class="icon-paperplane"></i><a href="#"> care@rmc.com</a></p>
						</div>
					</div>
				</div>
				<div class="col-md-4 sticky-parent">
					<div id="sticky_item">
						...
						<p class="btn-big"><a href="appointment.php" class="btn btn-primary">Make an Appoinment</a></p>
					</div>
				</div>
				...
				<style>
  				...
  				<br><br><center><h1>Location</h1></center><br>
 				<div id="map"></div>
  				<script>
    				function initMap(){
      // Map options
        			...
        			addMarker({coords:event.latLng});
     				 ...
     				 var markers = [
        				...
        				{
         				 coords:{lat:24.3720,lng:-88.5864},
